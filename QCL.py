...
from plot import plot_training, plot_pareto
...
# noise channel
def add_channel_noise(circuit, noise_model = None, noise_strength = 0.0):
...
def build_attack_circuit(params, case, noise_model = None, noise_strength = 0.0):
    circuit = cirq.Circuit()
...
# simulate
def simulate_case(params, case, noise_model = None, noise_strength = 0.0):
...
def average_fidelities(params, noise_model = None, noise_strength = 0.0, return_details = False):
    bob_scores = []
    eve_scores = []
    details = {}
...
def loss_and_gradient(params, target_bob, alpha = 10.0, noise_model = None, noise_strength = 0.0):
...
# optimize adam
def train_qcl(target_bob, *, alpha = 10.0, learning_rate = 0.1, steps = 100, seed = 42, initial_scale = 0.1, noise_model = None, noise_strength = 0.0, verbose=True):
...
def evaluate_known_pccm(theta, noise_model = None, noise_strength = 0.0):
    bob_scores = []
    eve_scores = []
